...
## 12.4 Nhóm sinh viên ICTU trình diễn tại chung kết
Mở đầu bằng radar của một doanh nghiệp thật. Sinh plan trước mặt giám khảo, chỉ vào mục bị khoá. Apply lên máy demo, verify xanh, đăng nhập vào hệ thống vừa sinh, gửi một khiếu nại, xem thông báo Telegram, bấm duyệt đề xuất AI. Cuối cùng chạy `dxforge apply --target proteus-manifest` và mở thư mục kết quả: một gói đúng định dạng của sản phẩm bạn cùng trường. Câu kết: "Chúng em không làm nền tảng thứ hai. Chúng em làm thứ sinh ra nền tảng."
