...
import { dtiLevel, dtiScore, mapHpdi, scoreAxes } from "./mapping.js";
import { assertSufficient, countResponses, mergeQuestions, scorePillars, scoreSupp } from "./scoring.js";
...
export { InsufficientResponses, assertSufficient, countResponses, mergeQuestions, scorePillars, scoreSupp } from "./scoring.js";
export { dtiLevel, dtiScore, mapHpdi, scoreAxes } from "./mapping.js";
...
export function compute(q: Questionnaire, responses: Response[]): ResultV1 {
  ...
  const axes = scoreAxes(q, responses, pillars);
  const hpdi = mapHpdi(axes, supp);
